# Bitácora — Plataformero 2D, jornada del 17-03-2026

> Esto era el `README.md` de la raíz de `codigos/` hasta el 01-09-2026.
> Era un registro de UNA jornada de un solo proyecto ocupando el índice de
> todo el repo, así que se movió aquí, que es de donde habla. El índice de
> proyectos vive ahora en [`../../README.md`](../../README.md) y la
> documentación viva del juego en [`README.md`](README.md).
